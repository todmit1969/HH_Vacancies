...
@pytest.fixture()
def HH_example():
    """Фикстура экземпляр класса HH_API"""
    return HH_API(base_url="https://api.hh.ru/vacancies")


@pytest.fixture
def vacancy_Python_developer():
    """Фикстура класса Vacancy Python разработчик"""
    return Vacancy(
...
@pytest.fixture
def mock_hh_api():
    """Создаем mock-объект для HH_API."""
    platform = HH_API(base_url="https://api.hh.ru/vacancies")
    return platform
...
def vacancy_without_url():
    """Фикстура, возвращающая данные для создания вакансии без url."""
...
def vacancy_with_salary_to_less_salary_from():
    """Фикстура, возвращающая данные для создания вакансии, где диапазон зарплаты - отрицательное число."""
